...
private let translationDict: [String: String] = [
    ...
    "Explore Soundboard…": "פתח ספריית צלילים…",
    "Explore Soundboard": "פתח ספריית צלילים",
    "Interactive Soundboard": "ספריית צלילים אינטראקטיבית",
    "All Sounds": "כל הצלילים",
    "Search sounds…": "חיפוש צלילים…",
    "Random Sound": "צליל אקראי",
    "Shuffle": "ערבב",
    "Tap any sound tile to preview and enjoy audio effects": "לחץ על כל אריח צליל כדי להאזין לאפקטי השמע",
    "Tap any sound tile to preview audio effects": "לחץ על כל אריח צליל כדי להאזין לאפקטי השמע",
    "Playing...": "משמיע...",
    ...
    "Bruh": "Bruh",
    "OOF (Roblox)": "OOF",
    "Windows Error": "שגיאת Windows",
    "What The Dog Doin": "What The Dog Doin",
    "Mario 1-Up": "מריו 1-Up",
    "Mario Power-Up": "מריו פטרייה",
    "Mario Jump": "מריו קפיצה",
    "Mario Pipe": "מריו צינור",
    "Illuminati (X-Files)": "תיקים באפלה",
    "Directed by (Curb)": "תרגיע",
    "Huh? (Cat)": "חתול Huh?",
    "Wilhelm Scream": "צעקת וילהלם",
    "Taco Bell Bong": "טאקו בל",
    "Quack": "ברווז",
    "Sheesh": "Sheesh",
    "Yeet": "Yeet",
    "Anime Wow": "Anime Wow",
    ...
    "Auto Layout Mode": "מצב סידור אוטומטי",
    "Records your arrangement to its own file as you work, so it survives a quit, a sleep or a reboot. Your saved sessions are never written to, but while this is on, automatic restores prefer the newer Auto layout over them. Switching it off stops the recording and leaves the file in place.": "שומר את סידור החלונות שלך בקובץ נפרד בזמן העבודה, כך שהוא נשמר גם לאחר יציאה, מצב שינה או הפעלה מחדש. המפגשים השמורים שלך לעולם אינם נכתבים מחדש, אך כאשר מצב זה מופעל, שחזורים אוטומטיים מעדיפים את הסידור האוטומטי החדש יותר. כיבוי המצב עוצר את ההקלטה ומשאיר את הקובץ במקומו.",
    "Auto Layout is on": "סידור אוטומטי מופעל",
    "Unavailable while Auto Layout is on": "לא זמין כאשר סידור אוטומטי מופעל",
    "Enable Desktop Toggle first": "הפעל תחילה את החלפת מצב שולחן העבודה",
    ...
    "Check for Updates Automatically": "בדוק אם קיימים עדכונים באופן אוטומטי",
    "Checks for new GitHub releases once daily when the app starts": "בודק אם קיימות גרסאות חדשות ב-GitHub פעם ביום עם הפעלת היישום",
    "Check for Updates…": "בדוק אם קיימים עדכונים…",
    "A new version of RememberMyWindows is available!": "גרסה חדשה של RememberMyWindows זמינה!",
    "Version %@ is now available—you have %@. Would you like to download it now?": "גרסה %@ זמינה כעת — ברשותך %@. האם להוריד אותה עכשיו?",
    "No release notes were provided.": "לא סופקו הערות לגרסה זו.",
    "Downloading update…": "מוריד עדכון…",
    "Open GitHub Release": "פתח גרסה ב-GitHub",
    "Skip This Version": "דלג על גרסה זו",
    "Remind Me Later": "הזכר לי מאוחר יותר",
    "Install Update": "התקן עדכון",
    "View Release": "הצג גרסה",
    "You're Up to Date": "ברשותך הגרסה העדכנית ביותר",
    "RememberMyWindows %@ is the latest version.": "RememberMyWindows %@ היא הגרסה העדכנית ביותר.",
    "Unable to Check for Updates": "לא ניתן לבדוק אם קיימים עדכונים",
    "OK": "אישור",
    // Notch Position HUD
    "Position '%@'": "מיקום '%@'",
    ...
    "AUTO LAYOUT": "סידור אוטומטי",
    "AUTO LAYOUT TIMELINE": "ציר זמן של סידור אוטומטי",
    "OTHER DISPLAYS": "צגים אחרים",
    "Captured %@": "נלכד %@",
    "Captured on a different display setup.": "הצילום בוצע בתצורת צגים אחרת.",
    "Nothing captured yet. Move a window and it will appear here.": "עדיין אין צילום. הזז חלון והוא יופיע כאן.",
    "1 earlier capture": "צילום קודם אחד",
    "earlier captures": "צילומים קודמים",
    "REMEMBERED DISPLAYS": "צגים שנזכרו",
    "LATEST CAPTURED WINDOWS": "חלונות אחרונים שנלכדו",
    "CAPTURED WINDOWS": "חלונות שנלכדו",
    "No remembered displays": "אין צגים שנזכרו",
    "Back to Latest": "חזרה לאחרון",
    "No windows captured yet": "אין חלונות שנלכדו עדיין",
    "Auto Layout Snapshots": "צילומי סידור אוטומטי",
    "Recent Auto Captures": "צילומי סידור אוטומטי אחרונים",
    "No auto captures yet": "אין צילומי סידור אוטומטי עדיין",
    "Auto Layout Restored": "סידור אוטומטי שוחזר",
    "Auto Layout Restore": "שחזור סידור אוטומטי",
    "Restore the auto layout": "שחזר את הסידור האוטומטי",
    "Show the newest automatic capture": "הצג את הצילום האוטומטי האחרון",
    "Selected": "נבחר",
    "Window Arrangement": "סידור חלונות",
    "When windows are restored from an auto layout snapshot": "כאשר חלונות משוחזרים מצילום סידור אוטומטי",
    "Restore this layout": "שחזר סידור זה",
    "Viewing Earlier Capture": "מציג צילום מוקדם יותר",
    "Return to Latest": "חזרה לאחרון",
    "No layout captured yet": "עדיין לא נלכדה פריסה",
    "Select and view this capture": "בחר והצג צילום זה",
    "Windows are captured automatically as you rearrange them.": "חלונות נלכדים אוטומטית בעת סידורם.",
    "From capture %@": "מצילום %@",
    "1 window": "חלון 1",
    "Captured %@ · %d/%d windows": "נלכד %@ · %d/%d חלונות",
    "Captured %@ · 1/1 window": "נלכד %@ · חלון 1/1",
    "just now": "הרגע",
    "%@ ago": "לפני %@",
    "Latest (%@) · 1 window": "האחרון (%@) · חלון 1",
    "Latest (%@) · %d windows": "האחרון (%@) · %d חלונות",
    "%@ · 1 window": "%@ · חלון 1",
    "%@ · %d windows": "%@ · %d חלונות",
    "Quit": "יציאה",
    // System Strings
    ...
    "Sound Volume": "עוצמת שמע",
    "Auto: 20% below system": "אוטומטי: 20% מתחת לעוצמת המערכת",
    "Automatically sets volume to 80% of system level (-20%)": "מכוון אוטומטית את עוצמת השמע ל-80% מעוצמת המערכת (הפחתה של 20%)",
    "Fixed at 80% (-20% from macOS master volume)": "קבוע על 80% (20% מתחת לעוצמת השמע הראשית של macOS)",
    "Test": "בדיקה",
    "Test sound": "בדוק צליל",
    "Preview volume with current sound": "האזן לבדיקת עוצמת השמע עם הצליל הנוכחי",

    // Event Cards in Notification Submenu
    "Full Layout Restore": "שחזור פריסה מלאה",
    "Display Connection & Change": "חיבור ושינוי צג",
    "Snapshot & App Update": "עדכון פריסה ויישום",
    "Desktop Toggle (⌘D)": "הצגת שולחן עבודה (⌘D)",
    "When all windows are hidden or shown via Cmd+D": "כאשר כל החלונות מוסתרים או מוצגים באמצעות Cmd+D",
    "Events": "אירועים",
    "Notification Sounds": "צלילי התראה",
    ...
    "Desktop Toggle shortcut": "קיצור מקשים להצגת שולחן העבודה",
    "Press any combination with at least one modifier": "הקש על צירוף מקשים עם מקש שינוי אחד לפחות",
    "Change…": "שנה…",
    "Random Sound (🎲)": "צליל אקראי (🎲)",
    "Play a random sound (🎲)": "השמע צליל אקראי (🎲)",
    "Next Feature": "תכונה הבאה",
    "Previous Feature": "תכונה קודמת",
    "Play Carousel": "הפעל מצגת",
    "Pause Carousel": "השהה מצגת",
    "Off": "כבוי",
    "System": "מערכת",
    "Your location is used to tag your saved window layouts so you can easily identify where they were saved. To turn the coordinates into a street address, they are sent to Apple once per saved layout. Nothing is sent to the developer.": "המיקום שלך משמש לתיוג פריסות החלונות השמורות כדי שתוכל לזהות בקלות היכן הן נשמרו. כדי להמיר את הקואורדינטות לכתובת רחוב, הן נשלחות ל-Apple פעם אחת לכל פריסה שנשמרת. שום מידע אינו נשלח למפתח.",

    // Notification Testing Previews & Delivery
    "Layout Restored": "הפריסה שוחזרה",
    "Display Connected": "צג חובר",
    "Restoring layout...": "משחזר פריסה...",
    "Permission required": "נדרשת הרשאה",
    "Cannot Add %@": "לא ניתן להוסיף את %@",
    "No open window detected": "לא זוהה חלון פתוח",
    "Opening %@": "פותח את %@",
    "Added": "נוסף",
    "Home": "בית",
